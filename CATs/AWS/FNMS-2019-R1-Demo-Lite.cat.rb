name 'FlexNet Management Suite 2019 Demo Lite'
rs_ca_ver 20161221
short_description "Creates an FNMS Demo Lite server instance in a discrete VPC."
long_description "The FlexNet Management Suite 2019 Demo Lite CloudApp deploys a demo Microsoft Active Directory domain and FlexNet Managemwnt Platform environment.
...
parameter "param_projectname" do
  ...
  allowed_values "Flexera","Demo","TestTrack","Training"
  default "Demo"
end
...
resource 'cat_server_fnms', type: 'server' do
  name join(["FNMS 2019 R1 Demo-", last(split(@@deployment.href,"/"))])
  cloud map($map_cloud, $param_location, "cloud")
  datacenter map($map_cloud, $param_location, "datacenter")
  network @vpc_network
  subnets @vpc_subnet
  security_groups @project_sg
  server_template find("FNMS-2019-R1-Demo-Lite",revision:7)
